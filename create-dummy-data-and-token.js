/**
 * Create dummy transactions AND generate a JWT token for testing
...
async function createDummyDataAndToken() {
  try {
    ...
    if (!mongoUri) {
      ...
      console.log('   Please add MONGODB_URL=mongodb://... to your .env file');
      process.exit(1);
    }
    ...
    // Get JWT config from environment or use defaults
    ...
    console.log('🎉 SUCCESS! Dummy data created and token generated!');
    console.log('='.repeat(70));
    console.log('');
